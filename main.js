...
const closedCookieImg = closedCookieDiv.querySelector(".closed-cookie img")
const fortuneMessage = openedCookieDiv.querySelector("#fortune-message")
...
function handleCookieClick(e) {
  ...
  fortuneMessage.innerText = fortuneMessages[randomNumber]

  toogleHide()
}

// event listeners
closedCookieImg.addEventListener("click", handleCookieClick)
resetBtn.addEventListener("click", toogleHide)
